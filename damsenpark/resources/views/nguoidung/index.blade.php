                            ...
                            <div class="tiket-left-child">
                                ...
                                <div class="div-form-tiket">
                                    ...
                                    @csrf
                                        ...
                                        <div class="input-f  ">
                                           <input type="number" name="soluong" class="qty-ticket-input" placeholder="Số lượng vé" >
                                           <input type="text" name="ngaydung" id="date" class="date-ticket-input" placeholder="Ngày sử dụng" id="">
